...
🗺️ Regional performance by state and region

💰 Category-wise profitability

🔄 Market basket analysis

📈 What-If quantity simulations
...
Total customers by region and state
...
Profit percentages across product categories
...
Baseline vs. “What-If” shipping scenario

Shipping savings from optimized operations
...
Data Cleaning & DAX Measures (if included)
...
What categories generate the most revenue and profit?

How does increasing or decreasing shipped quantity affect shipping costs?
...
Advanced DAX (Profit %, LTV, What-If parameters)

Complex Visualization Design

Geo-Mapping (State-level analytics)
...
Screenshoots/Demo
Show what the dashboard looklike
